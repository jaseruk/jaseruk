...
$PermissionPolicyReadAllAuditLog = $graph.AppRoles | where Value -Like "Auditlog.Read.All" | Select-Object -First 1
...
New-AzureADServiceAppRoleAssignment -Id $PermissionPolicyReadAllAuditLog.Id -ObjectId $msi.ObjectId -PrincipalId $msi.ObjectId -ResourceId $graph.ObjectId